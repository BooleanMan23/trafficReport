...
public class TrafficReports {
    ...
    public String getJalanLokasi() {
        return jalanLokasi;
    }

    public void setJalanLokasi(String jalanLokasi) {
        this.jalanLokasi = jalanLokasi;
    }

    private String jalanLokasi;
    ...
    public TrafficReports(String namaJalan, String deskripsi, String idPembuat, String idReport, String tanggalReport, String jalanLokasi) {
        this.namaJalan = namaJalan;
        this.deskripsi = deskripsi;
        this.idPembuat = idPembuat;
        this.idReport = idReport;
